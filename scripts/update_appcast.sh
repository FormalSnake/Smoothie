...
echo "
    <item>
      ...
      <sparkle:releaseNotesLink>https://github.com/FormalSnake/Smoothie/releases/latest</sparkle:releaseNotesLink>
      <enclosure
        url=\"https://github.com/FormalSnake/Smoothie/releases/download/v$version/$zipName\"
